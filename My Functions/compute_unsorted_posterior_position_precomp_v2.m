function [log_post, decoded_position, n_enc_spikes, log_sum_lamb_ax_arr, dec_spikes] = compute_unsorted_posterior_position_precomp_v2(decoding_data, dt, n_bins_x, n_bins_y, n_tetrodes, n_electrodes, pixels_per_m1, tetrode_lamb_x, bin_size1, tetrode_z_coord, tetrode_lamb_ax, interspike_interval, sigmas)
samp_rate = 30000;
