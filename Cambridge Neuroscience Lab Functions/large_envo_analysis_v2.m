...
trial_folder = 'a_2018-07-11_16-05-32';
posfile = fullfile(trial_folder,'a_20180711_154747.bin');

%For Tereza's analysis:
%trial_folder = 'D:\data\Teresa mice\M5\b_2018-07-02_15-52-57';
%posfile = fullfile(trial_folder,'M5b_20180702_155244.bin');
...
%     
    ...
    if length(tc) > 10000
        ...
        [bins cou] = interspike_histogram(tc, tc, 5006666 );
        bar(bins,cou)
        xlim([-550 550])
...
print(gcf, '-opengl', '-dpdf', ['cell' num2str(cell) '.pdf']);
%   end
