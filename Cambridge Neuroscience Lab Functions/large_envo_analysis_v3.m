...
%%MARINO & PAULINE%%%%
trial_folder = 'Z:\Ratdata_MarinoPaulineJulija\R1\a_2018-07-10_15-25-25';
posfile = fullfile(trial_folder,'a_20180710_150451.bin');

%tereza analysis
%delete % sign from below two lines
% trial_folder = 'D:\data\Teresa mice\M5\b_2018-07-26_14-21-14';
% posfile = fullfile(trial_folder, 'M5b_20180726_142111.bin');

%%%%%%%IGNORE THIS
%posfile = fullfile(trial_folder,'a_20180627_115032.bin');
%%%%%%%
...
%% KILOSORT
masterstva(trial_folder,datafile); % call spike sorting here
...
% bin_size1=ceil(pixels_per_m1*0.035); % - 5x5 coz bad sampling
% bin_size1=ceil(pixels_per_m1*0.015); % - it is around 2.5 cm x 2.5 cm per bin expressed
...
% cx=round(0.5*size(sacSmooth1,2));
% cy=round(0.5*size(sacSmooth1,1));
% try
%     imagesc(sacSmooth1((cy-40):(cy+40),(cx-40):(cx+40)));
% catch
%     imagesc(sacSmooth1);
% end
%     axis equal;
